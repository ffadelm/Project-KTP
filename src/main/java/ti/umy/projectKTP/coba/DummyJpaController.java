...
import ti.umy.projectKTP.coba.exceptions.NonexistentEntityException;
import ti.umy.projectKTP.coba.exceptions.PreexistingEntityException;
...
public class DummyJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ti.umy_projectKTP_jar_0.0.1-SNAPSHOTPU");
